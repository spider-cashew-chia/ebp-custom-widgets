...
// Legacy function for backwards compatibility (not needed but keeping for safety)
function initReadMoreButtons() {
  // Event delegation handles everything, but we can still initialize if needed
  const readMoreButtons = document.querySelectorAll('.read-more-btn');
  // Buttons are handled by event delegation above, so nothing needed here
}
